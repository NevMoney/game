Moralis.Cloud.define('getSVG', async (request) => {
  ...
  let CONTRACT_ABI = [
    ...
    {
      inputs: [{ internalType: 'uint256', name: '_hauntId', type: 'uint256' }],
      name: 'collaterals',
      outputs: [
        {
          internalType: 'address[]',
      ...
      inputs: [
        {
          components: [
            ...
            { internalType: 'string', name: '_collateralSvg', type: 'string' },
            {
              components: [
                { internalType: 'bytes32', name: 'svgType', type: 'bytes32' },
                { internalType: 'uint256[]', name: 'sizes', type: 'uint256[]' },
            ...
            { internalType: 'string', name: '_eyeShapeSvg', type: 'string' },
            {
              components: [
                { internalType: 'bytes32', name: 'svgType', type: 'bytes32' },
                { internalType: 'uint256[]', name: 'sizes', type: 'uint256[]' },
    ...
    {
      inputs: [
        { internalType: 'address[]', name: '_gameManagers', type: 'address[]' },
      ],
    ...
    {
      inputs: [
        { internalType: 'address[]', name: '_itemManagers', type: 'address[]' },
      ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: 'int8[6]', name: '_traitModifiers', type: 'int8[6]' },
        { internalType: 'uint8', name: '_rarityScoreModifier', type: 'uint8' },
      ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: 'uint256[]', name: '_toTokenIds', type: 'uint256[]' },
        { internalType: 'uint256[][]', name: '_ids', type: 'uint256[][]' },
        { internalType: 'uint256[][]', name: '_values', type: 'uint256[][]' },
      ],
  ...
  const svgString = await contract.methods
    .previewAavegotchi(
      hauntId,
      collateralAddress,
      request.params.numericTraits,
      request.params.equippedWearables,
    )
    .call()
